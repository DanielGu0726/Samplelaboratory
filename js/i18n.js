...
(function() {
  ...
  const translations = {
    ko: {
      ...
      // Home page
      'home.hero.title': '샘플 치과<br><em>기공소</em>',
      ...
      'about.intro.title': '샘플 치과기공소',
      'about.intro.desc': '저희 샘플 치과기공소는 2010년 설립 이래 최신 CAD/CAM 시스템과 디지털 장비를 활용하여 최고 품질의 치과 보철물을 제작해왔습니다. 환자의 만족과 치과의사의 신뢰를 최우선으로 하며, 지속적인 기술 개발과 품질 향상에 힘쓰고 있습니다.',
      ...
      'contact.email.text': 'info@samplelab.com',
    ...
    en: {
      // Page title
      'page.title': 'Sample Dental Laboratory',
      ...
      // Home page
      'home.hero.title': 'Sample Dental<br><em>Laboratory</em>',
      ...
      'about.intro.title': 'Sample Dental Laboratory',
      'about.intro.desc': 'Since our establishment in 2010, Sample Dental Laboratory has been creating the highest quality dental prosthetics using the latest CAD/CAM systems and digital equipment. We prioritize patient satisfaction and dentist trust, and are committed to continuous technological development and quality improvement.',
      ...
      'footer.name': 'Sample Dental Laboratory',
